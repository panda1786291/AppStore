...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("D:\\Computer\\JAVA\\JavaProject\\StoreApp_20220110\\service\\store-ums"
                + "/src/main/java");
        ...
        /*配置自动生成哪个数据库的文件*/
        dsc.setUrl("jdbc:mysql://121.41.1.232:3306/store_ums?serverTimezone=GMT%2B8");
